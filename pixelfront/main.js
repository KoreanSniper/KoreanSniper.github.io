...
const runFrame=()=>{b.step();e.step();for(const nation of e.nations)if(nation.spawn>=0&&nation.tiles.size>0&&!nation.alive)nation.alive=true;ui();r.draw();const me=e.nations[0];if(!e.spectating&&!me.alive&&me.tiles.size===0)finish(true);else if(e.winner!==null)finish(false)};
